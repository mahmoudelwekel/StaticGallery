...
function FillProducts(products, infolist, Categories) {
    ...
    div.insertAdjacentHTML('beforeend', "<div class='card text-right'><div class='row no-gutters'><div class='col-md-6 p-3'><a data-toggle='modal' href='#' data-target='#exampleModal'><img class='card-img img-fluid h-100 w-100 ' src='" + products[i].image + "' alt='' style='object-fit: contain;' /></a></div><div class='col-md-6'><div class='card-body'><h4 class='card-title font-weight-bold' dir='rtl'>" + products[i].name + "</h4><hr/><p class='card-text' dir='rtl'>" + products[i].description + "</p><hr/><p class='card-text' dir='rtl'>السعر : " + products[i].price + "</p><a href='https://wa.me/2" + infolist[0].phone + "?text=" + products[i].name + "' class='btn btn-primary font-weight-bold w-100' target='_blank'>اطلب الأن</a><hr /><p class='card-text' dir='rtl'><a class='btn btn-sm btn-outline-primary font-weight-bold ' href='index.html?cat=" + products[i].category + "'>قسم " + Categories[products[i].category].name + "</a></p><p class='card-text text-pre' dir='rtl'>" + Categories[products[i].category].description + "</p><hr /><p class='card-text text-center'>شارك الأن</p><div class='sharethis-inline-share-buttons'></div></div></div></div></div><div class='modal pt-0 fade' id='exampleModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'><div class='modal-dialog modal-dialog-centered modal-lg' role='document'><div class='modal-content'><div class='modal-header'><button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button></div><div class='modal-body p-0'><img class='img-fluid h-100 w-100' src='" + products[i].image + "' alt='' /></div></div></div></div><script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=5ea76d017ddbf2001271a27c&product=inline-share-buttons&cms=sop' async='async'></script>");
